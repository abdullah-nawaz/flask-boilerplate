...
def _compare_columns(
    ...
    for cname in set(conn_col_names).difference(metadata_col_names):
        if autogen_context.run_filters(conn_table.c[cname], cname, "column", True, None):
            modify_table_ops.ops.append(
...
def _compare_server_default(
    ...
    if sqla_compat.has_computed and isinstance(metadata_default, sa_schema.Computed):
