...
class ToxEnv(ABC):
    ...
    def register_config(self):
        ...
        self.conf.add_config(
            ...
            post_process=lambda v, _: list(
                itertools.chain.from_iterable(i.split(" ") for i in v)
            ),
        )
        self.conf.add_config(
            keys=["env_dir", "envdir"],
        ...
        self.conf.add_config(
            ...
            of_type=Path,
            default=lambda conf, name: conf.core["work_dir"]
            / conf[name]["env_name"]
            / "tmp",
