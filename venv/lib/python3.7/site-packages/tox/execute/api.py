...
class ExecuteInstance:
    def __init__(
        ...
        out_handler: ContentHandler,
        err_handler: ContentHandler,
    ) -> None:
    ...
    def __call__(self, request: ExecuteRequest, show_on_standard: bool) -> Outcome:
        ...
        try:
            with CollectWrite(sys.stdout if show_on_standard else None) as out:
                with CollectWrite(
                    sys.stderr if show_on_standard else None, Fore.RED
                ) as err:
                    instance = executor(
                        request, out.collect, err.collect
                    )  # type: ExecuteInstance
                    try:
                        ...
                        while True:
                            try:
                                ...
                                try:
                                    ...
                                    if (
                                        is_main and sys.platform != "win32"
