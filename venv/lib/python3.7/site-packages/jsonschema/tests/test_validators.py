...
class TestCreateAndExtend(SynchronousTestCase):
    ...
    def test_if_a_version_is_provided_it_is_registered(self):
        Validator = validators.create(
            meta_schema={"$id": "something"}, version="my version",
        )
    ...
    def test_validates_registers_meta_schema_draft6_id(self):
        ...
        validators.create(
            meta_schema=my_meta_schema, version="my version",
        )
        self.addCleanup(validators.meta_schemas.pop, meta_schema_key)
...
class TestLegacyTypeChecking(SynchronousTestCase):
    ...
    def test_extend(self):
        ...
        Extended = validators.extend(Validator, validators={"new": new},)
        self.assertEqual(
            (
                Extended.VALIDATORS,
                Extended.META_SCHEMA,
    ...
    def test_extending_a_legacy_validator_with_a_type_checker_errors(self):
        Validator = validators.create(
            meta_schema={}, validators={}, default_types={"array": list}
        )
        with self.assertRaises(TypeError) as e:
            validators.extend(
                Validator, validators={}, type_checker=TypeChecker(),
            )
...
class TestValidationErrorMessages(TestCase):
    ...
    def test_additionalItems_single_failure(self):
        message = self.message_for(
            instance=[2], schema={"items": [], "additionalItems": False},
        )
        self.assertIn("(2 was unexpected)", message)

    def test_additionalItems_multiple_failures(self):
        message = self.message_for(
            instance=[1, 2, 3], schema={"items": [], "additionalItems": False}
        )
    ...
    def test_contains(self):
        ...
        self.assertIn(
            "None of [2, {}, []] are valid under the given schema", message,
        )
    ...
    def test_additionalProperties_false_patternProperties(self):
        ...
        message = self.message_for(
            instance={"zebra": 123}, schema=schema, cls=validators.Draft4Validator,
        )
        self.assertEqual(
            message,
...
class ValidatorTestMixin(MetaSchemaTestsMixin, object):
    ...
    def test_it_creates_a_ref_resolver_if_not_provided(self):
        self.assertIsInstance(
            self.Validator({}).resolver, validators.RefResolver,
        )
...
class TestValidatorFor(SynchronousTestCase):
    def test_draft_3(self):
        ...
        self.assertIs(
            validators.validator_for(schema), validators.Draft3Validator,
        )
    ...
    def test_draft_4(self):
        ...
        self.assertIs(
            validators.validator_for(schema), validators.Draft4Validator,
        )
    ...
    def test_draft_6(self):
        ...
        self.assertIs(
            validators.validator_for(schema), validators.Draft6Validator,
        )
    ...
    def test_draft_7(self):
        ...
        self.assertIs(
            validators.validator_for(schema), validators.Draft7Validator,
        )
    ...
    def test_True(self):
        self.assertIs(
            validators.validator_for(True), validators._LATEST_VERSION,
        )

    def test_False(self):
        self.assertIs(
            validators.validator_for(False), validators._LATEST_VERSION,
        )
    ...
    def test_custom_validator(self):
        ...
        self.assertIs(
            validators.validator_for(schema), Validator,
        )
...
class TestRefResolver(SynchronousTestCase):
    ...
    def test_it_resolves_local_refs_with_id(self):
        ...
        resolver = validators.RefResolver.from_schema(
            schema, id_of=lambda schema: schema.get("id", ""),
        )
