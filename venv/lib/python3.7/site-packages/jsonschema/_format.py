...
def _checks_drafts(
    name=None, draft3=None, draft4=None, draft6=None, draft7=None, raises=(),
):
    ...
    def wrap(func):
        ...
        FormatChecker.cls_checks(draft7 or draft6 or draft4 or draft3, raises)(func,)
        return func
...
@_checks_drafts(
    draft3="host-name", draft4="hostname", draft6="hostname", draft7="hostname",
)
...
try:
    ...
    try:
        ...
        @_checks_drafts(
            draft6="uri-reference", draft7="uri-reference", raises=ValueError,
        )
...
try:
    ...
    @_checks_drafts(
        draft7="relative-json-pointer", raises=jsonpointer.JsonPointerException,
    )
...
try:
    ...
    def is_uri_template(
        instance, template_validator=uritemplate.Validator().force_balanced_braces(),
    ):
