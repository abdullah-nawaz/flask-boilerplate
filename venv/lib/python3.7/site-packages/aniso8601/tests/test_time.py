...
class TestTimeParserFunctions(unittest.TestCase):
    ...
    def test_parse_time(self):
        testtuples = (
            ...
            ("23:21:28,512400", {"hh": "23", "mm": "21", "ss": "28.512400", "tz": None}),
            ("23:21:28.512400", {"hh": "23", "mm": "21", "ss": "28.512400", "tz": None}),
            ("01:03:11.858714", {"hh": "01", "mm": "03", "ss": "11.858714", "tz": None}),
            (
                "14:43:59.9999997",
            ...
            ("144359.9999997", {"hh": "14", "mm": "43", "ss": "59.9999997", "tz": None}),
            ...
            (
                "01,4567+00:00",
                {"hh": "01.4567", "tz": (False, None, "00", "00", "+00:00", "timezone")},
            ),
            (
                "01.4567+00:00",
                {"hh": "01.4567", "tz": (False, None, "00", "00", "+00:00", "timezone")},
