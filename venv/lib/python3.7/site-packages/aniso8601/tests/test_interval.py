...
class TestRepeatingIntervalParserFunctions(unittest.TestCase):
    def test_parse_repeating_interval(self):
        ...
        with mock.patch.object(
            ...
            result = parse_repeating_interval(
                "R2--1980-03-05T01:01:00--" "1981-04-05T01:01:00", intervaldelimiter="--"
            )
        ...
        with mock.patch.object(
            ...
            result = parse_repeating_interval(
                "R2/" "1980-03-05 01:01:00/" "1981-04-05 01:01:00", datetimedelimiter=" "
            )
    ...
    def test_parse_interval_internal(self):
        ...
        _parse_interval(
            "1980-03-05 01:01:00/1981-04-05 01:01:00", mockBuilder, datetimedelimiter=" "
        )
