...
class TestPythonTimeBuilder(unittest.TestCase):
    ...
    def test_build_datetime_bounds_checking(self):
        ...
        with self.assertRaises(LeapSecondError):
            PythonTimeBuilder.build_datetime(
                ("2016", "12", "31", None, None, None, "date"),
                ("23", "59", "60", None, "time"),
            )
    ...
    def test_build_interval(self):
        testtuples = (
            ...
            (
                {
                    "end": ("2000", "01", "01", None, None, None, "date"),
                    "duration": (
            ...
            (
                ...
                datetime.date(year=1989, month=3, day=1),
                datetime.datetime(
                    year=1989, month=2, day=15, hour=0, minute=0, second=0, microsecond=1
                ),
            ),
            (
                {
                ...
                datetime.date(year=1989, month=3, day=1),
                datetime.datetime(
                    year=1989, month=2, day=27, hour=0, minute=0, second=0, microsecond=1
                ),
            ),
            (
                {
    ...
    def test_distribute_microseconds(self):
        ...
        self.assertEqual(
            PythonTimeBuilder._distribute_microseconds(211, (0, 0), (100, 10)), (2, 1, 1)
        )
