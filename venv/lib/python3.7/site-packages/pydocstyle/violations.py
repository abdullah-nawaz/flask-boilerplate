...
class Error:
    ...
    def __init__(
        self, code: str, short_desc: str, context: str, *parameters: Iterable[str]
    ) -> None:
...
class ErrorRegistry:
    ...
    class ErrorGroup:
        ...
        def create_error(
            self, error_code: str, error_desc: str, error_context: Optional[str] = None,
...
D401 = D4xx.create_error(
    "D401", "First line should be in imperative mood", "perhaps '{0}', not '{1}'"
)
D401b = D4xx.create_error(
    "D401", "First line should be in imperative mood; " "try rephrasing", "found '{0}'"
)
...
D412 = D4xx.create_error(
    "D412", "No blank lines allowed between a section " "header and its content", "{0!r}"
)
