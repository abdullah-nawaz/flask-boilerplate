...
SQLITE_DEV = "sqlite:///" + str(HERE / "flask_boilerplate_dev.db")
SQLITE_TEST = "sqlite:///" + str(HERE / "flask_boilerplate_test.db")
SQLITE_PROD = "sqlite:///" + str(HERE / "flask_boilerplate_prod.db")
